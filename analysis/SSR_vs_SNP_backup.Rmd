...
colnames(all_EST_SSR) <- c("EST_SSR", "Cohort")
...
ggsave(filename = "../results/figs/Abies_PA_SNP_vs_SSR.png",
...
ggsave(filename = "../results/figs/Abies_FIS_SNP_vs_SSR.png",
...
ggsave(filename = "../results/figs/Abies_uHe1_SNP_vs_SSR.png",
       width = 4, height = 4, units = "in", dpi = 300)
```
...
ggsave(filename = "../results/figs/Abies_uHe2_SNP_vs_SSR.png",
       width = 4, height = 4, units = "in", dpi = 300)
```
