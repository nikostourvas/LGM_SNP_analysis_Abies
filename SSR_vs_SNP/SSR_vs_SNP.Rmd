...
<!-- # Import csv -->
```{r include=FALSE}
snp <- read.csv("/home/rstudio/working/R_projects/LGM_SNP_analysis_Abies/data/Genotyping-1841.025-03 Grid_reformated.csv", 
                header = T, 
...
obj_SSR <- read.genalexcel(
  "/home/rstudio/working/R_projects/LGM_SNP_analysis_Abies/data/LGM_DE_SI_GR_final.xlsx",   # name of excel file
...
gi.test.1 <- obj_SNP
for (i in seq(5, length(locNames(obj_SNP)), 5)) {
  CIreps <- c()
  for (j in 1:10) {
